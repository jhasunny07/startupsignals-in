      ...
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 pb-20">
          ...
          <div className="lg:col-span-5 space-y-8">
            <Link
              href="/"
              className="text-3xl font-black tracking-[calc(-0.05em)] flex items-center gap-2 uppercase italic"
            >
              <span className="text-orange-600 tracking-tighter not-italic">
                ⚡
              </span>
              {BRAND_NAME}
              ...
              {[
                ...
                <li key={item}>
                  <Link
                    ...
                    className="hover:text-orange-600 transition-colors flex items-center gap-2 group"
                  >
                    {item}
