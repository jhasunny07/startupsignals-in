      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
            {/* Hardcoded teaser for now – later dynamic */}
            <div className="group overflow-hidden rounded-2xl border bg-white shadow-md hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 group-hover:text-indigo-600 transition-colors">
                  The Hardest Lesson I Learned Building My First Startup
                </h3>
                <p className="mt-3 text-gray-600 line-clamp-3">
                  Distribution beats product most of the time...
                </p>
                <Link href="/blog/hardest-lesson-first-startup" className="mt-4 inline-block text-indigo-600 font-medium hover:underline">
                  Read more →
                </Link>
              </div>
            </div>
            {/* Add 1-2 more teasers similarly if you want */}
          </div>
        </div>
      </section>
    </MainLayout>
