            ...
            <div className="lg:col-span-7 space-y-6 order-2 lg:order-1 text-center lg:text-left">
              ...
              <div className="pt-4">
                <Link
                  ...
                  className="inline-flex items-center gap-3 bg-slate-900 text-white px-8 py-4 rounded-full font-black text-xs uppercase tracking-widest hover:bg-blue-600 transition-all shadow-lg"
                >
              ...
              >
                <div className="flex items-center justify-between mb-10">
                  ...
                  <Link
                    ...
                    className="text-[10px] font-black text-blue-600 uppercase tracking-widest flex items-center gap-1 hover:underline transition-all"
                  >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                  ...
                  <div className="lg:col-span-7 group">
                    <Link
                      ...
                      className="relative block h-full min-h-[450px] overflow-hidden rounded-[2.5rem] bg-slate-900 shadow-xl"
                    >
                      ...
                      <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-end">
                        <div className="space-y-4 max-w-2xl">
                          <Badge className="bg-blue-600 text-white border-none text-[9px]">
                            LATEST
                          </Badge>
